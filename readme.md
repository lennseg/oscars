...
Once the data was displayed, I was having issues resetting the window modal. Data was being added if I kept clicking though the actors images. For example, if I selected Meryl Streep and then Jack Nicholson it would diplay both of their datas on the same window modal. 

In javascript, I removed the commas and formatted the list to show the current id for nominations, wins and genres. When another id was selected the list would reset. 
...
* Display a graph for the genres
* Add the age of each actor/actress first Academy nomination and first Academy win
* Re-create the graph that shows the number of nominations and wins for each actor and actress
